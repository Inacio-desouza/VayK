  ...
  <div class="calendar-activity-card" :class="{ 'timed-card': !!activity.time }">
    <div class="calendar-card-top">
      ...
      <div class="calendar-card-right">
        ...
        <button class="info-btn" data-tour="info-button" type="button" @click="handleOpenDetail">
        ...
        <button class="icon-btn remove" data-tour="remove-button" type="button" @click="handleRemove">×</button>
      </div>
    </div>
  </div>
</template>
